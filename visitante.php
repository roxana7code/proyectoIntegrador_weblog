...
<div class="menu-contenido" id="menu-contenido">
    <nav style="display: flex; align-items: center;">
        <ul style="display: flex; margin: 0; padding: 0;">
            <li class="tooltip">
                <a href="visitante.php"><i class="fas fa-home"></i></a>
            ...
            <li class="tooltip">
                <a href="/inicioSesion.php"><i class="fas fa-users"></i></a>
...
<a href="inicioSesion.php" style="display: inline-block; padding: 10px 20px; background-color: #2c3e50; color: whitesmoke; text-decoration: none; border-radius: 5px; font-weight: bold;">

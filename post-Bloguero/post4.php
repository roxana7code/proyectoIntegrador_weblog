    ...
    <div class="todo-contenido-post">
        <div class="posts-contenido">
            <div class="titulo-posts">
                <h1>Smoothie de Frutas y Avena    </h1>
            </div>
            <div class="inicio-posts">
                <p>Este smoothie es una excelente manera de comenzar el día con energía. Está lleno de vitaminas, minerales y fibra, y 
                es tan fácil de preparar que incluso los más pequeños de la casa pueden ayudar.  <p>
            </div>
            <div class="contenido-posts">
                <img src="../post_Img/post4.jpg" alt="">
                <h1>Ingredientes:</h1>
                <p><span class="post-2">•</span> 1 plátano maduro   </p>
                <p><span class="post-2">•</span> 1 taza de fresas frescas   </p>
                <p><span class="post-2">•</span> ½ taza de avena   </p>
                <p><span class="post-2">•</span> 1 taza de leche (puede ser leche de vaca, de almendras o de coco) </p>
                <p><span class="post-2">•</span> Miel o edulcorante al gusto (opcional)    </p>
                
                <h1>Pasos de preparación: </h1>
                <p><span class="post-2">1.</span> En una licuadora, combina el plátano, las fresas, la avena y la leche. </p>
                <p><span class="post-2">2.</span> Si lo deseas, agrega un poco de miel o edulcorante para endulzar.  </p>
                <p><span class="post-2">3.</span> Mezcla todo hasta obtener una consistencia suave y homogénea.  </p> 
                <p><span class="post-2">4.</span> Sirve el smoothie en vasos y decora con rodajas de fruta fresca si lo deseas. ¡Un desayuno delicioso y nutritivo en minutos!  </p>
                <img src="../post_Img/smoothie-preparacion.jpg" alt="">
